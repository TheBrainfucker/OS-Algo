...
public class SJF {
    ...
    public static void sjf(int[][] process) {
        ...
        li_remTime.sort(Comparator.comparingInt(a -> a[3]));// sort list by remaining time
        ...
        while (q_arrival.size() != 0 || li_remTime.size() != 0) {
            if (li_remTime.size() != 0) {
                ...
                for (; li_remTime.size() != 0; time_elapsed++) {// time++ loop until list is empty
                    ...
                    if (li_remTime.size() != 0) { // new process can arrive or not
                        li_remTime.sort(Comparator.comparingInt(a -> a[3]));// sort by remaining time
            ...
            // when waiting queue is empty but other processes are yet to be arrived
                ...
                li_remTime.sort(Comparator.comparingInt(a -> a[3]));
            }
        }
    ...
    public static void main(String[] agrs) {
        ...
        if (select == 0) {
            try {// read from SJFInput.txt file
                ...
                scan.close();
                System.out.println();
                System.out.println("Preemptive SJF || SRTF ALGO");
                sjf(process);
            } catch (Exception e) {
                e.getStackTrace();
            }
            ...
            System.out.println();
            System.out.print("Preemptive SJF || SRTF ALGO\nHow many processes: ");
            ...
            System.out.println("Choose either 0 or 1 -_-");
        }
    }
}
